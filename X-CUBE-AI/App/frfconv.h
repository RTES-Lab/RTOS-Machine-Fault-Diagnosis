...
#define AI_FRFCONV_ORIGIN_MODEL_NAME   "st_frfconvtds_1000_1013_v2"

/******************************************************************************/
#define AI_FRFCONV_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FRFCONV_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FRFCONV_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FRFCONV_IN_NUM        (1)

AI_DEPRECATED
#define AI_FRFCONV_IN \
  ai_frfconv_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FRFCONV_IN_SIZE { \
  AI_FRFCONV_IN_1_SIZE, \
}
#define AI_FRFCONV_IN_SIZE_BYTES { \
  AI_FRFCONV_IN_1_SIZE_BYTES, \
}
#define AI_FRFCONV_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FRFCONV_IN_1_HEIGHT      (2048)
#define AI_FRFCONV_IN_1_CHANNEL     (1)
#define AI_FRFCONV_IN_1_SIZE        (2048)
#define AI_FRFCONV_IN_1_SIZE_BYTES  (8192)

/******************************************************************************/
#define AI_FRFCONV_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FRFCONV_OUT \
  ai_frfconv_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FRFCONV_OUT_SIZE { \
  AI_FRFCONV_OUT_1_SIZE, \
}
#define AI_FRFCONV_OUT_SIZE_BYTES { \
  AI_FRFCONV_OUT_1_SIZE_BYTES, \
}
#define AI_FRFCONV_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FRFCONV_OUT_1_CHANNEL     (8)
#define AI_FRFCONV_OUT_1_SIZE        (8)
#define AI_FRFCONV_OUT_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_FRFCONV_N_NODES (74)
 ...
 * @ref ai_frfconv_create. Both the activations memory buffer 
 ...
 * using @ref ai_frfconv_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_frfconv_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_frfconv_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FRFCONV_*
 * defines into file @ref frfconv.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
