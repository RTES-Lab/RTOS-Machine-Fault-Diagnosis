...
/* ====== [ADD] 라벨/유틸 ====== */
static const char* kLabels8[8] = { "H","L","M1","M2","M3","U1","U2","U3" };
...
//  for (;;) {
//    MX_USB_HOST_Process();
//    vTaskDelayUntil(&t, pdMS_TO_TICKS(1));   // 1ms 권장 (혹은 2~5ms)
//  }
//}
...
//// LCD Task
// LCD Task: 16x2에 간단 메시지 주기적으로 출력
void vLCDTask(void *pvParameters)
{
    for (;;)
    {
